...
saveRDS(stats, 
        file = "/scratch/atm234/konza_birds/outputs/bird_bray_meanSD.RDS")
...
#                           TRUE ~ NA_real_))
# 
# saveRDS(subsamples, file = "/scratch/atm234/konza_birds/outputs/onesite_bray_samples.RDS")
# 
...
#                          year = year))
# 
# saveRDS(summary, file = "/scratch/atm234/konza_birds/outputs/onesite_bray_summary.RDS")
