...
saveRDS(mod, 
        file ="/scratch/atm234/konza_birds/outputs/bird_MSAM_RE_model3.RDS")
...
mcmcplot(mod$samples,
         parms = params2,
         dir = "/scratch/atm234/konza_birds/outputs/mcmcplots/MSAM_RE3")
...
saveRDS(Rhat, "/scratch/atm234/konza_birds/outputs/bird_MSAM_model_RE_Rhat3.RDS")
