...
mod <- readRDS(file ="/scratch/atm234/sbc_fish/outputs/fish_MSAM_RE_model5.RDS")
...
saveRDS(mod2, 
        file ="/scratch/atm234/sbc_fish/outputs/fish_MSAM_RE_model6.RDS")
...
mcmcplot(mod2$samples,
         parms = params2,
         dir = "/scratch/atm234/sbc_fish/outputs/mcmcplots/MSAM_RE6")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod2$Rhat

saveRDS(Rhat, "/scratch/atm234/sbc_fish/outputs/fish_MSAM_modelRE_Rhat6.RDS")
