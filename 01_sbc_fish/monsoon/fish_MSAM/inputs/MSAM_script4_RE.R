...
saveRDS(mod2, 
        file ="/scratch/atm234/sbc_fish/outputs/fish_MSAM_RE_model4.RDS")
...
mcmcplot(mod2$samples,
         parms = params2,
         dir = "/scratch/atm234/sbc_fish/outputs/mcmcplots/MSAM_RE4")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod2$Rhat

saveRDS(Rhat, "/scratch/atm234/sbc_fish/outputs/fish_MSAM_modelRE_Rhat4.RDS")
