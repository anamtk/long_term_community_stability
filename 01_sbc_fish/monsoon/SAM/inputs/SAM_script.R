...
data <- readRDS("/scratch/atm234/sbc_fish/SAM/inputs/bray_SAM_input_data.RDS")
...
saveRDS(mod, 
        file ="/scratch/atm234/sbc_fish/SAM/outputs/fish_SAM_model.RDS")
...
mcmcplot(mod$samples,
         dir = "/scratch/atm234/sbc_fish/SAM/outputs/mcmcplots/SAM")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/atm234/sbc_fish/SAM/outputs/fish_SAM_model_Rhat.RDS")
