...
#https://portal.edirepository.org/nis/mapbrowse?packageid=knb-lter-knz.26.12

#zipped version of data needs to be unzipped to run:
...
write.csv(birds5, here('data_output',
                       '02_birds',
                       '01_MSAM',
                       'other_data',
                       'all_bird_data.csv'))
...
write.csv(sites, here('data_output',
                      '02_birds',
                      '01_MSAM',
                      'other_data',
                      'site_year_IDs.csv'))
