...
#they are too big for GitHub, so users will need
#to download them and save them into the folder specified below
...
write.csv(size_df, here('data_output',
                        '01_fish',
                        '01_MSAM',
                        'other_data',
...
write.csv(fish4, here('data_output',
                      '01_fish',
                      '01_MSAM',
                      'other_data',
                      'all_fish_data.csv'))
...
write.csv(fish5, here('data_output',
                      '01_fish',
                      '01_MSAM',
                      'other_data',
                      "site_year_IDs.csv"),
...
write.csv(fish6, here('data_output',
                      '01_fish',
                      '01_MSAM',
                      'other_data',
                      "species_IDs.csv"),
...
saveRDS(raw_bray_all, here('data_output',
                           '01_fish',
                           '01_MSAM',
                           'other_data',
