model{
  ...
  #this model incorporates results from the MSAM on the mean
  #and variance of bray-curtis estimates into a beta regressin
  #exploring how beta diversity (dissimilarilty/stabiliyt) is 
  #shaped by environmental covaraites with antecedent effects
