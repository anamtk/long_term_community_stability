...
saveRDS(mod, 
        file ="/scratch/atm234/sev_hoppers/SAM/raw/outputs/sev_SAM_model2.RDS")
...
mcmcplot(mod$samples,
         dir = "/scratch/atm234/sev_hoppers/SAM/raw/outputs/mcmcplots/SAM2")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/atm234/sev_hoppers/SAM/raw/outputs/sev_SAM_model_Rhat2_raw.RDS")
