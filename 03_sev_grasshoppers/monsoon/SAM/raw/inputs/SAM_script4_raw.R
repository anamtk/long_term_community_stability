...
mod <- readRDS(file ='/scratch/atm234/sev_hoppers/SAM/raw/outputs/sev_SAM_model_raw3.RDS')
...
saveRDS(mod, 
        file ="/scratch/atm234/sev_hoppers/SAM/raw/outputs/sev_SAM_model_raw4.RDS")
...
mcmcplot(mod$samples,
         dir = "/scratch/atm234/sev_hoppers/SAM/raw/outputs/mcmcplots/SAM4")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/atm234/sev_hoppers/SAM/raw/outputs/sev_SAM_model_Rhat4_raw.RDS")
