...
mod <- readRDS(file ='/scratch/atm234/sev_hoppers/SAM/raw/outputs/sev_SAM_model2.RDS')
...
saveRDS(mod, 
        file ="/scratch/atm234/sev_hoppers/SAM/raw/outputs/sev_SAM_model_raw3.RDS")
...
mcmcplot(mod$samples,
         dir = "/scratch/atm234/sev_hoppers/SAM/raw/outputs/mcmcplots/SAM3")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/atm234/sev_hoppers/SAM/raw/outputs/sev_SAM_model_Rhat3_raw.RDS")
