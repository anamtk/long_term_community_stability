...
data <- readRDS("/scratch/atm234/nps_plants/inputs/nps_msam_multisite_all.RDS")
...
saveRDS(mod, 
        file ="/scratch/atm234/nps_plants/outputs/nps_JAGS_model_all.RDS")
...
mcmcplot(mod$samples,
         dir = "/scratch/atm234/nps_plants/outputs/mcmcplots/MSAM_all")
...
saveRDS(Rhat, "/scratch/atm234/nps_plants/outputs/nps_MSAM_model_Rhat_all.RDS")
